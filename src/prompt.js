...
3. [Hiếm] (Cơ chế Đặc biệt): Vật phẩm bắt đầu có "cơ chế hoạt động" riêng biệt. Có thể thay đổi một phần nhỏ cục diện, mang lại lợi ích rõ rệt nhưng sẽ có thời gian hồi chiêu (cooldown) hoặc điều kiện kích hoạt. (Ví dụ: Đồng hồ ngưng đọng thời gian khu vực nhỏ trong 5 giây, Cuốc chim tự động đào khoáng khi chủ nhân ngủ).
